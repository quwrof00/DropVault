...
export default function HomePage() {
 ...
 <div className="md:col-span-2 bg-gray-900 border border-gray-800 hover:border-blue-500/30 rounded-2xl p-6 flex flex-col justify-between group hover:shadow-xl hover:shadow-blue-900/5">
 <div className="mb-6">
 <div className="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center mb-4 text-blue-400 group-">
 ...
 <div className="w-full h-28 bg-gray-950 rounded-xl border border-gray-800/50 p-3 font-mono text-[10px] text-gray-500 overflow-hidden relative opacity-70 group-hover:opacity-100">
 ...
 <div className="md:row-span-2 md:col-span-2 lg:col-span-1 lg:row-span-1 bg-gray-900 border border-gray-800 hover:border-yellow-500/30 rounded-2xl p-6 flex flex-col group hover:shadow-xl hover:shadow-yellow-900/5">
 <div className="w-10 h-10 bg-yellow-500/10 rounded-lg flex items-center justify-center mb-4 text-yellow-500 group-">
 ...
 {/* Square Card: Code */}
 <div className="bg-gray-900 border border-gray-800 hover:border-emerald-500/30 rounded-2xl p-6 group hover:shadow-xl hover:shadow-emerald-900/5">
 <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center mb-4 text-emerald-400 group-">
 ...
 {/* Square Card: Global */}
 <div className="bg-gray-900 border border-gray-800 hover:border-cyan-500/30 rounded-2xl p-6 group hover:shadow-xl hover:shadow-cyan-900/5">
 <div className="w-10 h-10 bg-cyan-500/10 rounded-lg flex items-center justify-center mb-4 text-cyan-400 group-">
