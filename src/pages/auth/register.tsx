...
'bg-green-500'
 ...
 {/* Abstract blobs */}
 <div className="absolute top-[-20%] right-[-20%] w-[80%] h-[80%] bg-indigo-600/10 rounded-full blur-[100px] -slow"></div>
 <div className="absolute bottom-[-20%] left-[-20%] w-[80%] h-[80%] bg-blue-600/10 rounded-full blur-[100px] -slow"></div>
 ...
 <div
 key={i}
 className={`flex-1 rounded-full ${i < passwordStrength ? passwordStrengthColors[passwordStrength - 1] :'bg-gray-800'}`}
 />
 ))}
 </div>
 </div>
