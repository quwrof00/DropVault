  ...
  return (
    <div className="flex min-h-screen bg-gray-950 font-sans selection:bg-blue-500/30 text-white">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-gray-900 overflow-hidden items-center justify-center p-12 border-r border-gray-800">
        {/* Abstract blobs */}
        <div className="absolute top-[-20%] left-[-20%] w-[80%] h-[80%] bg-blue-600/10 rounded-full blur-[100px] animate-pulse-slow"></div>
        <div className="absolute bottom-[-20%] right-[-20%] w-[80%] h-[80%] bg-indigo-600/10 rounded-full blur-[100px] animate-pulse-slow delay-1000"></div>
          ...
          {!showReset ? (
            ...
            <form onSubmit={handleResetPassword} className="space-y-5">
              <button
                ...
                className="flex items-center space-x-2 text-sm text-gray-400 hover:text-white transition-colors mb-4"
                disabled={isLoading}
              >
                <ArrowLeft size={16} />
