...
function TiptapEditor({
 ...
 className={`p-1.5 px-2 rounded-md ${editor.isActive('paragraph')
 ?'bg-blue-500/20 text-blue-400 shadow-sm border border-blue-500/20'
 :'text-gray-400 hover:bg-gray-700 hover:text-gray-200'
 }`}
 title="Paragraph"
...
'0'
 ...
 className={`p-1.5 rounded-md flex items-center gap-1 ${editor.isActive('bulletList')
 ?'bg-blue-500/20 text-blue-400 shadow-sm border border-blue-500/20'
 :'text-gray-400 hover:bg-gray-700 hover:text-gray-200'
 }`}
 title="Bullet List"
...
'border-orange-500/20 bg-orange-500/10 text-orange-400'
 ...
 className={`flex items-center gap-1.5 p-1.5 px-3 rounded-md text-sm font-medium ${copied ?'text-green-400' :'text-gray-400 hover:bg-gray-700 hover:text-gray-200'}`}
