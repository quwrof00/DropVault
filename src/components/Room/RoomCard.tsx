...
export function RoomCard({ room, onLeave, onRename, isCreator }: RoomCardProps) {
 ...
 return (
 <div
 className="bg-gray-800 rounded-xl shadow-lg hover:shadow-xl hover:bg-gray-600"
 >
 ...
 className="text-sm text-gray-400 hover:text-red-400 px-2 py-1 rounded-md hover:bg-gray-700"
 >
 Leave
 </button>
 </div>
