...
export default function Codes({ roomId }: CodesProps) {
 ...
 logActivity(user.id, "create_snippet", trimmedTitle);
 ...
 logActivity(user.id, "delete_snippet", title);
 ...
 {/* Editor Area */}
 <div className="flex-1 flex flex-col p-4 sm:p-6 lg:p-8 overflow-auto bg-gray-700">
 ...
 {isSaving && (
 <div className="flex items-center gap-2 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full text-green-400">
